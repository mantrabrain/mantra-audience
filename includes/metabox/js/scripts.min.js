...
window.Mantra_Audience_Metabox=function(a){function g(c){var b="";a('input[type="checkbox"]',c).each(function(){b+=a(this).attr("id")+"="+a(this).val()+"&"});a('input[type="text"]',c).val(b.slice(0,-1))}var d={init:function(){this.bind_events()},bind_events:function(){a(document).ready(d.document_ready)},document_ready:function(){d.init_metabox_tabs();d.gallery_shortcode();d.repeater();d.enable_toggle();d.query_category();d.post_meta_checkbox();d.init_fields(a("body"));d.audioRemoveAction()},init_metabox_tabs:function(){a(".mantra-audience-meta-box-tabs").each(function(){var c=
a(this),b=a(".ilc-htabs li",c);1<b.length?ilcTabs({ilctabs:"#"+c.attr("id")}):(a(".ilc-tab",c).show(),b.addClass("select"))});a(".ilc-htabs a").on("click",function(){d.set_cookie("mantra-audience-builder-tabs",a(this).attr("id"))});"undefined"!=typeof d.get_cookie("mantra-audience-builder-tabs")&&null!==d.get_cookie("mantra-audience-builder-tabs")&&a("#"+d.get_cookie("mantra-audience-builder-tabs")).trigger("click")},init_fields:function(c){d.layout(c);d.color_picker(c);d.date_picker(c);d.assignments(c);d.dropdownbutton(c);a(document).trigger("mantra_audience_metabox_init_fields",
[d])},repeater:function(){a("body").on("click",".mantra-audience-repeater-add",function(c){c.preventDefault();var b=a(this).closest(".mantra_audience_field_row");c=b.find(".mantra-audience-repeater-rows");var b=b.find(".mantra-audience-repeater-template").html(),e=1;c.find("> div").length&&(c.find("> div").each(function(){e=Math.max(e,a(this).data("id"))}),e++);b=a(b.replace(/__i__/g,e));b.find(".ajaxnonceplu").attr("id","");c.append(b);b.has(".plupload-upload-uic").length&&b.find(".plupload-upload-uic").each(function(){mantra_audience_create_pluploader(a(this))});
d.init_fields(c.find(".mantra-audience-repeater-row:last-child"))});a("body").on("click",".mantra-audience-repeater-remove-row",function(c){c.preventDefault();a(this).parent().remove()})},audioRemoveAction:function(){a("body").on("click","[data-audio-remove] a",function(c){c.preventDefault();var b=a(this).parent();c=b.data("audio-remove");var e=function(){b.parent().find(".mantra_audience_upload_field").val("");b.addClass("hide")};e();c.action="mantra_audience_remove_audio";a.post(ajaxurl,c,e)})},color_picker:function(c){c.find(".colorSelectInput").each(function(){var b=
{},c=a(this).data("format");"rgba"==c?(b.format="rgb",b.opacity=!0):"rgb"==c&&(b.format="rgb");a(this).minicolors(b)});c.find(".clearColor").on("click",function(){a(this).parent().find(".colorSelect").minicolors("value","");a(this).parent().find(".colorSelectInput").val("");a(this).hide()})},date_picker:function(c){c.find(".mantraAudienceDatePicker").each(function(){var b=a(this),c=b.data("label"),f=b.data("close"),h=b.data("dateformat"),d=b.data("timeformat"),k=b.data("timeseparator");(a.fn.mantraAudienceDatetimepicker?
a.fn.mantraAudienceDatetimepicker:a.fn.datetimepicker).call(b,{showOn:"both",showButtonPanel:!0,closeButton:f,buttonText:c,dateFormat:h,timeFormat:d,stepMinute:5,firstDay:b.data("first-day"),separator:k,onClose:function(c){""!=c&&a("#"+b.data("clear")).addClass("mantraAudienceFadeIn")},beforeShow:function(){a("#ui-datepicker-div").addClass("mantraAudienceDateTimePickerPanel")}});b.next().addClass("button")});c.find(".mantraAudienceClearDate").on("click",function(b){b.preventDefault();b=a(this);a("#"+b.data("picker")).val("").trigger("change");
b.removeClass("mantraAudienceFadeIn")})},assignments:function(a){a.find(".mantra-audience-assignments, .mantra-audience-assignment-inner-tabs").tabs()},layout:function(c){c.find(".preview-icon").each(function(){var b=a(this),c=b.parent(),f=c.find(".val"),h="",d="";if(0<b.closest(".group-hide").length){d="theme-settings";var k=b.closest(".group-hide");h=k.data("hide")}else 0<b.closest(".mantra_audience_field_row").length&&(d="custom-panel",k=b.closest(".mantra_audience_field_row"),"undefined"!==typeof k.data("hide")&&(h=k.data("hide")));
b.click(function(a){a.preventDefault();c.find(".selected").removeClass("selected");b.addClass("selected");f.val(b.find("img").attr("alt")).trigger("change");""!==h&&("custom-panel"==d?(a=k.nextUntil("[data-hide]"),a.add(a.find(".mantra_audience_field .hide-if")).not(".toggled-off").filter("."+h.replace(/\s/g,",.")).show().filter("."+f.val()).hide()):"theme-settings"==d&&k.find(".hide-if").filter("."+h.replace(/\s/g,",.")).show().filter("."+f.val()).hide())});if(""!==h)if("custom-panel"==d){var m=k.nextUntil("[data-hide]");
m.add(m.find(".mantra_audience_field .hide-if")).not(".toggled-off").filter("."+h.replace(/\s/g,",.")).filter("."+f.val()).hide()}else"theme-settings"==d&&k.find(".hide-if").filter("."+h.replace(/\s/g,",.")).show().filter("."+f.val()).hide()});c.find(".mantra_audience_field .preview-icon").on("click",function(b){b.preventDefault();a(this).parent().find(".selected").removeClass("selected");a(this).addClass("selected");a(this).parent().find(".val").val(a(this).find("img").attr("alt")).trigger("change")});c.find(".mantra_audience_field_row[data-hide]").each(function(){var b=
...
var c=b.find("input.ddbtn-all");"yes"==c.val()&&(b.hasClass("multi-ddbtn")?a(".multi-ddbtn-sub",b.parent().parent()).addClass("disabled opacity-5"):c.prev().siblings(".dropdownbutton-list").addClass("disabled opacity-5"))})},gallery_shortcode:function(){var c=wp.media.gallery.shortcode,b=wp.media.gallery,d;a("body").on("click",".mantra-audience-gallery-shortcode-btn",function(e){var f=a(this).closest(".mantra_audience_field").find(".mantra-audience-gallery-shortcode-input");f.html()&&(f.val(f.html()),f.html(""),f.text(""));
...
c=0;c<b.length;c++){for(var d=b[c];" "==d.charAt(0);)d=d.substring(1,d.length);if(0==d.indexOf(a))return d.substring(a.length,d.length)}return null},enable_toggle:function(){var c=a(".enable_toggle");0<c.length&&c.each(function(){var b=a(this).closest(".mantra_audience_write_panel");a(".mantra-audience-toggle",b).hide().addClass("toggled-off")});a(".enable_toggle .preview-icon").on("click",function(b){var c=a(this).find("img").attr("alt"),c=""!=a.trim(c)?"."+c+"-toggle":".default-toggle";a(this).closest(".inside").find(".mantra-audience-toggle").hide().addClass("toggled-off");
...
a(this).hasClass("enable_toggle_child")&&a(this).find("input[type=radio]:checked").siblings("input[type=radio]").each(function(){var b=a(this).val();setTimeout(function(){0!=b&&""!==b&&a("."+b+"-toggle").hide().addClass("toggled-off")},500)})})});a('.enable_toggle input[type="checkbox"]').on("click",function(){var b=a(this).data("val"),b=0!=b&&""!=b?"."+b+"-toggle":".default-toggle";a(this).closest(".inside").find(".mantra-audience-toggle").hide().addClass("toggled-off");a(this).prop("checked")&&a(this).closest(".inside").find(b).show().removeClass("toggled-off")});
a('.enable_toggle input[type="checkbox"]:checked').each(function(){var b=a(this).data("val");a(0!=b&&""!==b?"."+b+"-toggle":".default-toggle").show().removeClass("toggled-off")})},query_category:function(){function c(a,b){""!=b?a.closest(".inside").find(".mantra_audience_field_row").removeClass("query-field-hide"):a.closest(".inside").find(".mantra_audience_field_row").not(a.closest(".mantra_audience_field_row")).not(".query-field-visible").addClass("query-field-hide")}var b=a(".mantra_audience_field"),d=a(".mantra-audience-info-link");
b.find(".query_category").blur(function(){var b=a(this),d=b.val();a(this).parent().find(".val").val(d);c(b,d)}).keyup(function(){var b=a(this),d=b.val();a(this).parent().find(".val").val(d);c(b,d)});b.find(".query_category_single").change(function(){var b=a(this),d=b.val();b.parent().find(".query_category, .val").val(d);c(b,d)}).closest(".mantra_audience_field_row").addClass("query-field-visible");d.closest(".mantra_audience_field_row").addClass("query-field-visible");a(".query_category_single, .query_category").each(function(){var b=
a(this),d=b.val();c(b,d)});d.closest(".mantra_audience_field_row").removeClass("query-field-hide")},post_meta_checkbox:function(){a(".post-meta-group").each(function(){var c=a(this);a(".meta-all",c).prop("checked")&&a(".meta-sub",c).prop("disabled",!0).parent().addClass("opacity-7");c.on("click",".meta-all",function(){a(this).prop("checked")?a(".meta-sub",c).prop("disabled",!0).prop("checked",!1).parent().addClass("opacity-7"):a(".meta-sub",c).prop("disabled",!1).parent().removeClass("opacity-7")})});a(".custom-post-meta-group").each(function(){var c=
