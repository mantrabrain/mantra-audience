...
(function(a){var c={init:function(){this.galleryShortcode()},galleryShortcode:function(){var d=wp.media.gallery.shortcode,c=wp.media.gallery,b;a(".mantra-audience-gallery-shortcode-btn").on("click",function(e){var f=a(this).closest(".mantra_audience_field").find(".mantra-audience-gallery-shortcode-input");f.html()&&(f.val(f.html()),f.html(""),f.text(""));b?b.open():b=0<a.trim(f.val()).length?c.edit(a.trim(f.val())):wp.media.frames.file_frame=wp.media({frame:"post",state:"gallery-edit",title:wp.media.view.l10n.editGalleryTitle,
